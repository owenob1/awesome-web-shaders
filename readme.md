...
- [wgpu-matrix](https://github.com/greggman/wgpu-matrix) ⭐475 - Fast matrix and vector math tuned for WebGPU and WGSL layouts.
...
- [wgsl_reflect](https://github.com/brendan-duncan/wgsl_reflect) ⭐291 - A WGSL parser and reflection library for JavaScript.
...
- [Shader Web Background](https://github.com/xemantic/shader-web-background) ⭐281 - A drop-in library for fullscreen fragment-shader page backgrounds.
...
- [infinite-world](https://github.com/brunosimon/infinite-world) ⭐625 - A procedurally generated, infinite world in WebGL with Three.js.
...
- [glsl-film-grain](https://github.com/mattdesl/glsl-film-grain) ⭐207 - Animated film-grain noise as a GLSL module.
...
- [WebGPU Inspector](https://github.com/brendan-duncan/webgpu_inspector) ⭐355 - A browser extension for debugging WebGPU commands and shaders.
...
- [wgsl-analyzer](https://github.com/wgsl-analyzer/wgsl-analyzer) ⭐692 - Language-server tooling (autocomplete, diagnostics) for WGSL.
- [WESL](https://github.com/wgsl-tooling-wg/wesl-js) ⭐44 - A linker that adds imports and conditional compilation to WGSL.
...
- [three-agent-skills](https://github.com/emalorenzo/three-agent-skills) ⭐43 - Multi-platform rules for Three.js and R3F with GLSL and TSL shader best practices.
- [r3f-skills](https://github.com/EnzeD/r3f-skills) ⭐108 - A pack of React Three Fiber agent skills, including a dedicated shader-material skill.
- [procedural-clouds-threejs](https://github.com/CK42BB/procedural-clouds-threejs) ⭐41 - A skill teaching WebGPU raymarched volumetric clouds with a WebGL 2 fallback.
